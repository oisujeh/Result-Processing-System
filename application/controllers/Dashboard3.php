...
inner join tblcourses on tblcourses.id = tblcourse_reg.course_id
 where  grade = 'F' and level_id = $l_level and session_id = $l_session and mat_no = '$matno' order by tblcourses.id");
