    <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Buy History</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
                     ...
                     <?php  $this->load->view('partials/messages');?>
                        ...
                        <div class="table-responsive">
                            ...
                            <tr><th>#id</th><th>Item</th><th>Username</th><th>We Pay to Wallet</th><th>Amount (USD)</th> <th>Amount (Naira)</th> <th>You pay to Bank</th> <th>Screenshot</th> <th>Status</th> <th></th>
                            </tr>
								<?php foreach ($get_trans->result() as $data): ?>
                                    ...
                                    <td>
									  ...
									  <td><img src="<?php echo base_url().'assets/uploads/'.$data->screenshot ?>" width="400" height="100" alt="<?php echo $data->screenshot ?>"></td>
                                    ...
                                    <td><?php  if ($data->status  == 0) { ?>
                                     ...
                                     <td> <?php  if ($data->status  == 0) { ?>
                                             ...
                                             <a href="<?php echo "confirm_user/".$data->trans_id ?>"
                                                 ...
                                                 <a href="<?php echo "cancel_buy/".$data->trans_id ?>"
