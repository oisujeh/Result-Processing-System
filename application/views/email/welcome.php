          ...
          <tr>
            <td id="templateContainerHeader" valign="top" mc:edit="welcomeEdit-01">
              <p style="text-align:center;margin:0;padding:0;">
                 ...
                 <img src="<?php echo base_url('assets/frontend/img/core-img/logo.jpg') ?>"
              ...
              "brdBottomPadd-two" id="templateContainer" width="100%">
                <tr>
                  <td class="bodyContent" valign="top" mc:edit="welcomeEdit-02">
                    ...
                    <h1><strong>Welcome to Ecxhub Ecurrency Marketplace</strong></h1>

                    <h3>Thanks for joining our ecurrency marketplace. Its the first ever ecurrency marketplace in
                        Nigeria. Never lose your hard earned money to ecurrency fraudsters again.
                    We're excited to have you with us.</h3>
                  </td>
                </tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        "top" mc:edit="welcomeEdit-04">
                          <h4><strong>Mr C. O. Jibunoh</strong></h4>

                          <h5>C.E.O ecxhub.com</h5>
                        </td>
                      </tr>
                    </table>
                  </td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <tr valign="top">
                        <td valign="top" mc:edit="welcomeEditImgFirst" style="width:19%;color:#505050;font-family:Helvetica;font-size:14px;padding-bottom:1.143em;">
                         ...
                         <img height="" src="<?php echo base_url('assets/images/circle.jpg') ?>"
                        ...
                        <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                          <h3><strong>Start selling BTC, Ethereum etc</strong></h3>
                          <h4>We are the biggest crypto exchangers</h4>
                        </td>
                      ...
                      <tr valign="top">
                        ...
                        <td valign="top" mc:edit="welcomeEditTxtFirst" style="width:71%;color:#505050;font-family:Helvetica;font-size:14px;padding-top:0.714em;">
                          <h3><strong>Start selling Crypto</strong></h3>
                          <h4>Be a part of the community of sellers today. Login and click on post sales</h4>
                        </td>
                      ...
                      <tr valign="top">
                        ...
                        <td valign="top" mc:edit="welcomeEditTxtFirst">
                          ...
                          <h4>Our community is only as good as its members.</h4>
                        </td>
              ...
              "templateContainerFooter" width="100%">
                <tr>
                  <td valign="top" width="100%" mc:edit="welcomeEdit-11">
                    <p style="text-align:center;"><img height="" src="<?php echo base_url('assets/images/circle.jpg') ?>"
                    style="margin:0 auto 0 auto;display:inline-block;"></p>

                    <h6 style="text-align:center;margin-top: 9px;">https://bitcoin360exchange.com</h6>
